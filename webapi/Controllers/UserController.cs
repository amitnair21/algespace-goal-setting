...
namespace webapi.Controllers
{
    [ApiController]
    [Route("[controller]")]
    internal class UserController(IUserService userService) : Controller // Controller is only required for conducting studies, set scope is internal to hide actions
    {
        ...
        private IActionResult SetUser(string username, string password, StudyType studyType, int studyId, string? expiratonDate, AgentCondition? agentCondition)
        {
            try
            {
