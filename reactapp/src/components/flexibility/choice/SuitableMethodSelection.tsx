...
export function SuitableMethodSelection({ firstEquation, secondEquation, question, loadNextStep, agentType }: { firstEquation: FlexibilityEquation; secondEquation: FlexibilityEquation; question: string; loadNextStep: (method: Method) => void; agentType?: AgentType }): ReactElement {
    ...
    return (
        <React.Fragment>
            ...
            <FlexibilityHint hints={[FlexibilityTranslations.SUITABLE_HINT]} agentType={agentType} agentExpression={AgentExpression.Neutral} disabled={false} />
        </React.Fragment>
    );
