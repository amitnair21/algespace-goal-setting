...
function SingleChoiceExercise({ method, text, selfExplanation, loadNextStep, agentType, trackAction, trackError }: {
    method: Method;
    text: ReactElement;
    selfExplanation: SelfExplanation;
    loadNextStep: () => void;
...
function MultipleChoiceExercise({ method, text, selfExplanation, loadNextStep, agentType, trackAction, trackError }: {
    method: Method;
    text: ReactElement;
    selfExplanation: SelfExplanation;
    loadNextStep: () => void;
