    ...
    return (
        <React.Fragment>
            ...
            <MethodApplication system={transformedSystem !== undefined ? transformedSystem : initialSystem} firstVariable={firstVariable} secondVariable={secondVariable}
                               ...
                               trackError={trackError} isTip={isTip} />
        </React.Fragment>
    );
}

function MethodApplication({ system, firstVariable, secondVariable, isolatedVariables, loadNextStep, agentType, trackAction, trackError, isTip }: {
