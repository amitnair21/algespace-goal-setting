...
export function EqualizationMethod({ initialSystem, transformedSystem, loadNextStep, agentType, trackAction, trackError }: {
...
export function MethodApplication({ system, loadNextStep, agentType, trackAction, trackError }: {
    ...
    return (
        <DndContext sensors={sensors} onDragEnd={handleDragEnd} modifiers={[snapCenterToCursor]}>
            ...
            <FlexibilityHint hints={[FlexibilityTranslations.EQUALIZATION_HINT]} disabled={disabled} agentType={agentType} agentExpression={AgentExpression.Neutral} />
