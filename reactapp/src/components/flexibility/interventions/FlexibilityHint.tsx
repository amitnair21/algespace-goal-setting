...
export function FlexibilityHint({ hints, disabled, agentType, agentExpression }: { hints: string[]; disabled: boolean; agentType?: AgentType; agentExpression?: AgentExpression }): ReactElement {
